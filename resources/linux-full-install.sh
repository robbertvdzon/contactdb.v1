...
#note: to get an overview of all properties, install a package the normal way and perform the following: 'debconf-get-selections | grep phpmyadmin',
#you then see all propertie and values that belong to this installation
